...
export function Contact() {
  return (
    <section id="contact" className="py-24 px-4 bg-neutral-50 dark:bg-neutral-900/50">
          ...
          {contactItems.map((item, i) => {
            ...
            return (
              <motion.a
                ...
                className="block"
              >
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-shadow overflow-hidden rounded-xl bg-white dark:bg-neutral-800 dark:border dark:border-neutral-700">
                  <CardHeader>
                    <motion.div
                    ...
                    <CardTitle className="text-center text-xl text-neutral-900 dark:text-white">
                      {item.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
