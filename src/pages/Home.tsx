  ...
  const services = [
    {
      ...
      description: 'Complete brand strategy and identity design that converts prospects into loyal customers.',
      icon: '🎯'
    },
    {
      title: 'Social Media Marketing',
      description: 'Data-driven campaigns that build communities and drive engagement across all platforms.',
      icon: '📱'
    }
  ];
        ...
        <Container className="relative z-10 h-full flex items-center my-44">
          ...
          >
            ...
            >
              <Typography
                variant="h1"
                className={`${isDarkMode ? 'text-white' : 'text-black'} font-extrabold  mb-4`}
                sx={{
              ...
              <Typography
                variant="h2"
                className={`${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-8`}
                sx={{
                  fontFamily: 'Coolvetica, Arial, sans-serif',
    ...
    <Container className="flex flex-col items-center justify-center h-full">
        ...
        <Container>
          ...
          >
            <Typography
              ...
              sx={{ fontFamily: 'Coolvetica, Arial, sans-serif' , fontSize: { xs: '2rem', sm: '2.5rem', md: '3rem' } , my: 2 }}
            >
            ...
            <Typography
              ...
              sx={{ textAlign: 'justify', fontSize: '1.125rem', lineHeight: 1.8 }}
            >
              At CreatKaro, we believe every brand has a unique story waiting to be told. 
              Our team of creative strategists, designers, and digital marketing experts work 
              collaboratively to transform your vision into powerful brand experiences that 
              resonate with your audience and drive measurable results. From comprehensive 
              brand development to cutting-edge digital marketing campaigns, we craft solutions 
              that not only look exceptional but perform exceptionally. Our data-driven approach 
              ensures that every creative decision contributes to your bottom line, helping you 
              build lasting relationships with your customers while achieving sustainable growth 
              in today's competitive marketplace.
            </Typography>
          </motion.div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto my-10">
            <div className="bg-card/50 p-8 rounded-2xl border border-border hover:border-orange-500 
     ...
     transition-all duration-300  hover:glow-orange">
              ...
              <p className="text-muted-foreground">
                Complete brand identity creation from logo design to brand guidelines, ensuring your business stands out
            ...
            <div className="bg-card/50 p-8 rounded-2xl border border-border hover:border-orange-500 hover:shadow-[0_0_15px_5px_rgba(249,115,22,0.5)] transition-all duration-300 hover:glow-orange">
              ...
              <p className="text-muted-foreground">
                Strategic social media campaigns that engage your audience, build brand awareness, and drive meaningful
                business results.
              </p>
            </div>
          </div>
